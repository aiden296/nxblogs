...
In theory, we could use Distributed Transactions to ensure Atomicity. However, "tying" both Cache and Database into a single transaction would cause significant latency. Therefore, a more practical goal is to achieve Eventual Consistency.
...
When the App Server communicates with Database and Cache, we face the Dual Write problem:
