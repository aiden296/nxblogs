...
*   **S3 Object Lock:** You can use S3 Object Lock to store objects using a _write once, read many_ (WORM) model. Using S3 Object Lock, you can prevent an object from being deleted or overwritten for a fixed amount of time or indefinitely.
