...
![Erasure Coding Overview](/erasure-coding-overview.svg)
...
![Simple Parity](/erasure-coding-simple-parity.svg)
...
![Reed-Solomon Polynomial](/erasure-coding-reed-solomon.svg)
...
![Encoding Matrix](/erasure-coding-encoding-matrix.svg)
...
![Decoding Process](/erasure-coding-decoding.svg)
...
![Replication vs Erasure Coding](/erasure-coding-replication-vs-ec.svg)
