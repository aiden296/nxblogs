...
* **Application-level Security:** Deep integration with WAF to block attacks like SQL Injection or XSS.
...
ALB performs "Connection Termination". In contrast, NLB simply "Forwards" the packet. This makes NLB significantly more resilient during sudden traffic spikes (like Flash Sales).
