...
**Amazon CloudFront** is AWS's CDN, reducing latency and improving access speed through **Edge Locations** around the world.
...
- When a request reaches CloudFront, the system looks up a GeoIP Database to determine the requester's country
...
- **Can be bypassed with a VPN**: a VPN allows users to hide their true location and bypass Geo Restriction
...
For more granular control, consider AWS WAF:
