...
* **DELETE:** Postgres **does not immediately delete** the data from disk. It only marks the tuple as "dead" (Dead Tuple).
...
This is the mechanism of the MVCC system. Keeping the "corpses" of old data allows Postgres to manage transactions, support rollbacks, and ensure consistency when multiple connections read/write simultaneously (read consistency) without requiring overly strict locks.
