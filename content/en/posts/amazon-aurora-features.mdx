...
- Compute is measured in ACU, each ACU ≈ 2GB RAM
...
- PITR: restore the database to **any second** within the retention period. Aurora creates a new cluster from the backup.
