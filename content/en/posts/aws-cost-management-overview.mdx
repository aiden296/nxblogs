...
Rules can be based on multiple dimensions: by account, by service, by tag, by charge type, and so on. Once defined, the category is usable throughout Cost Explorer, Budgets, and CUR. Think of Cost Categories as a "mapping layer" that turns a messy technical structure into a tidy financial one. This service is **free**.
