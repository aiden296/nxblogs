...
This is where NACL comes in. NACL lets you write **Deny** rules to stop traffic right at the subnet gateway — before it ever reaches any instance inside.
...
NACL is a virtual firewall that operates at the **subnet** level. If you think of a [VPC](/en/posts/vpc-overview) as a city district and subnets as neighborhoods, then NACL is the **fence** surrounding each neighborhood — controlling who can enter (Inbound) and who can leave (Outbound).
