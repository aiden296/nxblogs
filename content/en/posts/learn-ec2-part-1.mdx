...
- AMI: A "template" containing the operating system (Linux, Windows) and pre-installed software.
...
- EBS: Think of it as a **Google Drive** or a USB connected over the network (Network Drive).
