...
Nếu bạn từng nghe về CDN, thì đây chính là nó. Với hơn 400 điểm tại 90 thành phố, Edge Location giúp đưa nội dung đến gần người dùng nhất có thể, giảm thiểu độ trễ (latency).
...
Khi vừa tạo tài khoản, bạn có **Root Account**. Lời khuyên xương máu là: **Đừng bao giờ dùng Root Account cho công việc hằng ngày.** Hãy dùng nó để tạo một User admin riêng cho mình, thiết lập MFA và cất "chiếc chìa khóa" Root này vào tủ kính.
