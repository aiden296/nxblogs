...
Trên lý thuyết, chúng ta có thể dùng Distributed Transaction để đảm bảo tính Atomicity. Tuy nhiên, việc "trói" cả Cache và Database vào chung một transaction sẽ gây ra độ trễ lớn. Do đó, mục tiêu khả thi hơn là đạt được Eventual Consistency.
...
Khi App Server giao tiếp với Database và Cache, chúng ta đối mặt với bài toán Dual Write:
