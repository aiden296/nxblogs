...
DNS là hệ thống phân tán có nhiệm vụ **dịch tên miền sang địa chỉ IP** mà máy tính có thể hiểu. Nó hoạt động như một cuốn danh bạ điện thoại của Internet: tên miền là "tên người", IP là "số điện thoại".
...
TLD là phần đuôi của domain. TLD server quản lý danh sách tất cả các domain dưới một đuôi cụ thể — và đặc biệt là biết **authoritative server của từng domain** đó nằm ở đâu.
...
TTL là số giây mà một resolver được phép giữ kết quả trong cache trước khi phải đi hỏi lại. TTL được khai báo bởi authoritative server, đi kèm mỗi record.
