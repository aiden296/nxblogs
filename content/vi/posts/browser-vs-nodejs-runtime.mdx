...
2. **Parser**: Xây dựng AST
3. **Bytecode Interpreter**: Thực thi bytecode ngay — startup nhanh, nhưng chưa tối ưu
4. **JIT Compiler**: Khi phát hiện code "hot" (chạy nhiều lần), JIT biên dịch trực tiếp thành machine code tối ưu
...
WinterCG là nỗ lực chuẩn hoá một tập API tối thiểu chung cho tất cả runtime: Node.js, Deno, Bun, Cloudflare Workers. Mục tiêu: viết một lần, chạy mọi nơi — ít nhất là cho phần không liên quan đến DOM hay file system.
