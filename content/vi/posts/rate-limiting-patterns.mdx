...
- **GCRA.** Một biến thể toán học gọn của token bucket, chỉ cần lưu **1 số** (`theoretical arrival time`) thay vì 2 (tokens + last_refill). Redis module `redis-cell` implement chính xác cái này.
