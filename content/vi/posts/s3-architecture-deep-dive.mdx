...
*   **S3 Object Lock:** Bạn có thể sử dụng S3 Object Lock để lưu object sử dụng mô hình _write once, read many_ (WORM — ghi một lần, đọc nhiều lần). Sử dụng S3 Object Lock, bạn có thể ngăn object bị xóa hoặc ghi đè trong khoảng thời gian cố định hoặc vô thời hạn.
