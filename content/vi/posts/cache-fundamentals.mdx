...
Việc lưu trữ toàn bộ Database vào RAM là bất khả thi về mặt chi phí đối với hầu hết hệ thống. Tuy nhiên, hành vi truy cập dữ liệu của người dùng thường tuân theo Nguyên lý Pareto và tính cục bộ của dữ liệu:
...
Hiệu quả của Cache được đo bằng chỉ số AMAT. Đây là công thức nền tảng để đánh giá độ trễ trung bình của hệ thống:
