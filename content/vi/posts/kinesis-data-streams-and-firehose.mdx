...
- Amazon MSK cũng có thể là source cho Firehose.
...
Sau bước Lambda transformation (hoặc ngay sau khi nhận records nếu không có Lambda), Firehose có thể **convert format** dữ liệu từ JSON/CSV sang **Apache Parquet** hoặc **Apache ORC** — hai columnar storage formats được sử dụng rộng rãi trong analytics.
