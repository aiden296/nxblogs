...
- `UUID v4` cho mỗi row một giá trị rải đều khắp không gian khóa. Hai row `INSERT` liền nhau về thời gian (do đó nằm liền nhau trên heap) lại có UUID **cách nhau cực xa** trong index → correlation gần 0.
