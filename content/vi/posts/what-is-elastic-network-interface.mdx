...
Nếu coi EC2 Instance là một chiếc máy tính, thì Elastic Network Interface (ENI) chính là chiếc card mạng giúp máy tính đó "nói chuyện" được với thế giới bên ngoài.
