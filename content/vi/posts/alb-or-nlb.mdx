...
* **Bảo mật mức ứng dụng:** Tích hợp sâu với WAF để chặn các cuộc tấn công như SQL Injection hay XSS.
...
ALB thực hiện cơ chế "Connection Termination". Ngược lại, NLB chỉ đơn giản là "Forward" gói tin. Điều này giúp NLB bền bỉ hơn hẳn khi gặp các đợt traffic tăng đột biến (như Flash Sale).
