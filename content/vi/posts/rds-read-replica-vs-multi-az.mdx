...
- **1 Standby instance** ở AZ-B — là một bản sao synchronous replication của primary.
...
- Primary die → AWS tự động failover DNS endpoint sang standby (~60–120s).
...
- **Asynchronous replication** — primary không chờ replica xác nhận, nên ghi nhanh hơn nhưng replica luôn có replication lag, từ vài ms đến vài giây tùy tải.
