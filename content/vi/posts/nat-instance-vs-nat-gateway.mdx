...
Vì NAT Instance là EC2, bạn có thể (và phải) gắn Security Group. Đây vừa là **ưu điểm** (kiểm soát chi tiết traffic) vừa là **trách nhiệm** (cấu hình sai = mất kết nối).
