...
Đây không chỉ tốn thời gian mà còn **tốn CPU** — cả hai bên phải thực hiện phép toán mã hóa bất đối xứng để trao đổi key.
...
- **Flush TLB** — bảng cache mapping virtual address sang physical address
