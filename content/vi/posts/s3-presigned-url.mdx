...
Khi bạn tạo một S3 bucket, mặc định nó hoàn toàn **private** — chỉ có IAM principal mới truy cập được. Browser hay mobile app của user không có AWS credentials, nên không thể gọi thẳng S3 API.
...
Backend sử dụng SigV4 để ký URL. Quy trình ở mức khái niệm:
