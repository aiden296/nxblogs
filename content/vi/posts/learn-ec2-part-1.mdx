...
- AMI: "Khuôn mẫu" chứa hệ điều hành (Linux, Windows) và các phần mềm cài sẵn.
...
- EBS: Hãy nghĩ về nó như một cái **Google Drive** hay một cái USB cắm qua mạng (Network Drive).
