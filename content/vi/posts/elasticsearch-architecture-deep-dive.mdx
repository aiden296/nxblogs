...
**Phase 2 — Translog replay**: Trong lúc phase 1 chạy, primary vẫn nhận write. Những write đó được ghi vào **translog**. Sau khi phase 1 xong, target node "replay" translog để bắt kịp với primary. Cuối cùng cluster đánh dấu shard mới là active.
